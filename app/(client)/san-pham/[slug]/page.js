...
export default function ProductDetailPage() {
    ...
    const handleAddToCart = () => {
        ...
        const noteValues = Object.values(selectedAttributes || {});
        const note = noteValues.length ? noteValues.join(", ") : "";
        ...
        const item = {
            ...
            priceBuy: pricing.originalPrice,
            qty: quantity,
            currency: "VND",
        ...
        if (idx > -1) {
            ...
            cart[idx].thumbnail = item.thumbnail || cart[idx].thumbnail;
            cart[idx].note = item.note;
        } else {
            cart.push(item);
        }
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex gap-4">
                            ...
                            <button
                                ...
                                className="flex-1 bg-gradient-to-r from-orange-500 to-red-500 text-white py-4 px-6 rounded-xl font-semibold hover:from-orange-600 hover:to-red-600 transition-colors"
                            >
                                Mua ngay
                            </button>
                        </div>
